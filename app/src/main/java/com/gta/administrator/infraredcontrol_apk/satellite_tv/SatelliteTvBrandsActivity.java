package com.gta.administrator.infraredcontrol_apk.satellite_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_brands_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        startActivity(new Intent(SatelliteTvBrandsActivity.this, com.gta.administrator.infraredcontrol_apk.satellite_tv.HW_TV.class));
                        break;
                }
            }
        });
